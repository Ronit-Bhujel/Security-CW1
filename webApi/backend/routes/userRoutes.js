...
router.get("/create", (req, res, next) => {
  res.status(405).json({
    error: "GET request is not allowed in this Technorica website developed by Shreejan Manandhar",
  });
});
...
router.put("/create", (req, res, next) => {
  res.status(405).json({
    error: "PUT request is not allowed in this Technorica website developed by Shreejan Manandhar",
  });
});
...
router.delete("/create", (req, res, next) => {
  res.status(405).json({
    error: "DELETE request is not allowed in this Technorica website developed by Shreejan Manandhar",
  });
});
